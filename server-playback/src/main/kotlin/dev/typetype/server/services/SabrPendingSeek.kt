...
fun SabrSessionHolder.consumeMatchingSeek(request: SabrSegmentRequest): Boolean {
...
fun SabrSessionHolder.prepareForExplicitRewind(request: SabrSegmentRequest): Unit =
    session.prepareForRewind(request, explicitSeekPositionMs())

fun SabrSessionHolder.prepareForExplicitForwardJump(request: SabrSegmentRequest): Unit =
    session.prepareForForwardJump(request, explicitSeekPositionMs())

fun SabrSessionHolder.prepareForHistoricalLiveRewind(request: SabrSegmentRequest): Unit {
