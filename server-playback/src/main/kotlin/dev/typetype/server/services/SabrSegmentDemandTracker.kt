...
object SabrSegmentDemandTracker {
...
fun SabrSessionHolder.requestSegmentDemand(
...
fun SabrSessionHolder.clearSegmentDemand(request: SabrSegmentRequest): Unit =
    SabrSegmentDemandTracker.clear(this, request)

fun SabrSessionHolder.clearSegmentDemands(): Unit = SabrSegmentDemandTracker.clear(this)

fun SabrSessionHolder.nextSegmentDemand(): SabrSegmentRequest? = SabrSegmentDemandTracker.next(this)

fun SabrSessionHolder.segmentDemandIdentity(request: SabrSegmentRequest): String? =
    SabrSegmentDemandTracker.identity(this, request)

fun SabrSessionHolder.isSegmentDemandActive(request: SabrSegmentRequest, identity: String): Boolean =
...
fun SabrSessionHolder.pendingSegmentDemandSummary(): String? = SabrSegmentDemandTracker.pendingSummary(this)
