...
fun SabrSessionHolder.mediaRequestsAt(playerTimeMs: Long): List<SabrSegmentRequest> =
    mediaRequestsAt(playerTimeMs, activeGeneration())

fun SabrSessionHolder.repositionTargets(
...
fun SabrSessionHolder.mediaRequestsAt(playerTimeMs: Long, generation: Long): List<SabrSegmentRequest> = buildList {
