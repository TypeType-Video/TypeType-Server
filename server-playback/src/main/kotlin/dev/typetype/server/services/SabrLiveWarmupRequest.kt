...
data class SabrLiveWarmupTarget(
    val sequence: Int,
    val timeMs: Long,
    val segmentDurationMs: Long,
)

fun SabrSessionHolder.liveWarmupTarget(): SabrLiveWarmupTarget? {
...
fun SabrSessionHolder.advanceLiveWarmupTarget(
...
inline fun <T> withLiveWarmupRequestShape(
...
@PublishedApi internal fun YoutubeSabrFormat.liveWarmupRange(targetSequence: Int, targetTimeMs: Long): SabrBufferedRange {
