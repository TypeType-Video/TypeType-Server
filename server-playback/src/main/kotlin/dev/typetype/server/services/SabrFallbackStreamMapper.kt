...
fun StreamResponse.withSabrFallback(videoId: String, info: YoutubeSabrInfo): StreamResponse {
...
fun TokenYoutubeSession.toFallbackStreamResponse(videoId: String): StreamResponse = StreamResponse(
    id = videoId,
    title = title,
    uploaderName = author,
