...
val GOOGLEVIDEO_URL_REGEX = Regex("""https://[a-z0-9.\-]+\.googlevideo\.com/\S+""")
...
fun rewriteHlsManifest(manifest: String): String =
...
fun acceptsYoutubeThumbnailFallback(url: String, status: Int, contentType: String?): Boolean {
